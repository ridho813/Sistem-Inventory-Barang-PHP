...
<div class="container">
    <br>
    <h4>Laporan Daftar Barang Keluar</h4>
...
if (isset($_POST['tgl_awal'])&& isset($_POST['tgl_akhir'])) {
          ...
          $tgl_akhir=date('Y-m-d', strtotime($_POST["tgl_akhir"]));
            ...
            $sql="select * from barang_keluar where tanggal between '".$tgl_awal."' and '".$tgl_akhir."' order by idbrg_keluar asc";

        }else {
            $sql="select * from barang_keluar  k, barang s where s.kode_barang =k.kode_barang order by idbrg_keluar asc";
        }
